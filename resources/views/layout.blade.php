                     ...
                     <nav class="menunav">
                        <ul class="ulwap-mainmenu">
                           ...
                           <li class="" style="border-color:white">
                              ...
                              Tour Hè 2023
                              <img alt="du lịch" class="icon-posmenu" src="{{asset('frontend/images/icon-news.gif')}}">                                                </a>
                              <ul>
                                 <li class="" style="border-color:white">
      ...
      <div class="container-fluid">
         <div class="slider-wrapper theme-default">
            <div id="slider-master" class="nivoSlider">
               <a href="https://vietnamtravel.net.vn/vi/loai-tour/30-4/1.html"><img src="{{asset('frontend/images/bai-dinh-trang-an.jpg')}}" data-thumb="{{asset('frontend/images/bai-dinh-trang-an.jpg')}}" alt="aa" title="" /></a>
         ...
         <div class="row">
            ...
            <div class="col-md-4 col-xs-12 bx-child-ph bx-child-ph3">
               ...
               <ul class="lst-thumb-video-home top-15" style="">
                  <li><img src="{{asset('frontend/images/thai-lan.png')}}" alt="2" src-video="https://www.youtube.com/embed/yWM-oOLOYNs?rel=0"></li>
                  <li><img src="{{asset('frontend/images/singapo-malaysia.jpg')}}" alt="2" src-video="https://www.youtube.com/embed/ZjtJIi39r4U?rel=0"></li>
                  <li><img src="{{asset('frontend/images/da-nang.jpg')}}" alt="2" src-video="https://www.youtube.com/embed/YgrvXPK4u4s?rel=0"></li>
               </ul>
            </div>
         </div>
      </div>
